...
Abilities.Monk = {
    Windwalker = {
        ...
        SpinningCraneKick = { showConditions = false, checkHealthLevel = false, healthLevel = 0, healthOp = "=", checkChiLevel = false, chiOp = "=", chiLevel = 0, checkEnergyLevel = false, energyOp = "=", energyLevel = 0, forceMeleeRangeCheck = true, spellId = 101546, aoe = true },
